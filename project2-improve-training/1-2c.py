...
model = NN([784, 10], [logistic], learning_rate=0.1, mini_batch_size=100, lambda_1=0.1, lambda_2=0, random_state=456, force_square_error=False)
accs = model.train(X_train, Y_train, eval_set=(X_test, Y_test), epochs=100, early_stopping=10)

np.save("results/1-2c.npy", accs)
