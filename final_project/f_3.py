...
layers = [Input(input_dim),
	...
	Unfold(name="unfold"),
#	FullyConnected([7*7*64, output_dim], name="fc2")
]
...
model.save_params("results/f_3_params.npz")

print("Saving accuracies . . . ")
with open("results/f_3_accs.csv", "w") as fp:
	fp.write("epoch,acc\n")
	for i, a in enumerate(accs):
		fp.write(str(i+1)+","+str(a)+"\n")

print("Saving test predictions . . . ")
with open("results/f_3_preds.csv", "w") as fp:
...
with open("results/f_3_arc.csv", "w") as fp:
	fp.write("rej,acc\n")
