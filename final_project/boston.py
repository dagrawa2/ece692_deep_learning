# this script implements a vanilla GP regressor
# on the classic Boston house-prices data set
# we use the GPFlow package to do this
...
# instantiate a vanilla GP regressor
...
# train the model
gpflow.train.ScipyOptimizer().minimize(model, maxiter=100)
