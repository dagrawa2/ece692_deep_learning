...
model.save_params("results/c_1_params.npz")

print("Saving accuracies data . . . ")
with open("results/c_1_accs.csv", "w") as fp:
	fp.write("epoch,acc\n")
	for i, a in enumerate(accs):
		fp.write(str(i+1)+","+str(a)+"\n")

print("Saving test predictions . . . ")
with open("results/c_1_preds.csv", "w") as fp:
...
with open("results/c_1_arc.csv", "w") as fp:
	fp.write("rej,acc\n")
