...
'''
    This function performs various data augmentation techniques to the dataset
...
def augment_data(dataset, dataset_labels, augmentation_factor=1, use_random_rotation=True, use_random_shift=True, use_random_zoom=True):
	augmented_image = []
