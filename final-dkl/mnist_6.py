...
model.kern.base_kernel.variance.trainable = True
model.kern.base_kernel.lengthscales.trainable = True

print("Training base kernel parameters . . . ")
accs = model.train(eval_set=(X_test, Y_test), epochs=10)
print("Saving accuracies . . . ")
np.save("results/mnist_6_accs_1.npy", accs)
...
accs = model.train(eval_set=(X_test, Y_test), epochs=10)
print("Saving accuracies . . . ")
np.save("results/mnist_6_accs_2.npy", accs)

print("Saving model parameters . . . ")
model.save_params("results/mnist_6_params.npz")
